...
FileProgress.prototype.setComplete = function(up, info) {
    ...
    var showImg = $('<img src="/tools/qiniu/images/loading.gif"/>');

    progressNameTd.append(Wrapper);

    if (!isImg) {
        showImg.attr('src', '/tools/qiniu/images/default.png');//上传失败默认显示的图片
        ...
        $(img).on('load', function() {
            ...
            function initImg(url, key, height) {
                ...
                modalBody.find('img').attr('src', '/tools/qiniu/images/loading.gif');
            ...
            fopLink.on('click', function() {
                ...
                fopArr.push({
                    fop: 'watermark',
                    // mode: 1,
                    // image: 'https://www.caihongwen.cn/image/myself.jpg',//水印图片
                    mode: 2,  // 文字水印
                    text: 'Cheirsh', // 水印文字，mode = 2时，必需
                    dissolve: 70,          // 透明度，取值范围1-100，非必需，下同
                    gravity: 'SouthEast',  // 水印位置SouthEast，同上
                ...
                $('#myModal-img').on('hide.bs.modal', function() {
                    ...
                    $('#myModal-img').find('.text-warning').hide();
                    //搞内容到可以被复制到剪贴板
                    $(".btn-success").attr("data-clipboard-text", url);
                });
            ...
            showImg.attr('src', '/tools/qiniu/images/default.png');
            Wrapper.addClass('default');
        });
    }
};
