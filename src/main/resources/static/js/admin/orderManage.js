	...
	$(document).ready(function() {
		oTable = $('#otable').DataTable(
			...
			"ajax" : function(data, callback, settings) {
				//封装请求参数
				var param = orderManage.getQueryCondition(data);
				$.ajax({
					type : "GET",
					url : "/order/page",//TODO
					cache : false, //禁用缓存
	...
	var orderManage = {
		...
		getQueryCondition : function(data) {
			...
			//组装查询参数
			param.fuzzySearch = orderManage.fuzzySearch;
			if (orderManage.fuzzySearch) {//模糊查询
				param.fuzzy = $("#fuzzy-search").val();
			} else {//非模糊查询
                param.orderSn = $("#orderSn").val();
