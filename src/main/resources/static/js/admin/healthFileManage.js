	...
	$(document).ready(function() {
		oTable = $('#otable').DataTable(
			...
			"ajax" : function(data, callback, settings) {
				//封装请求参数
				var param = healthFileManage.getQueryCondition(data);
				$.ajax({
					type : "GET",
					url : "/healthFile/page",//TODO
					cache : false, //禁用缓存
					data : param, //传入已封装的参数
					dataType : "json",
	...
	var healthFileManage = {
		...
		getQueryCondition : function(data) {
			...
			//组装查询参数
			param.fuzzySearch = healthFileManage.fuzzySearch;
			if (healthFileManage.fuzzySearch) {//模糊查询
