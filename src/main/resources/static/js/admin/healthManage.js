	...
	$(document).ready(function() {
		oTable = $('#otable').DataTable(
			...
			"ajax" : function(data, callback, settings) {
				//封装请求参数
				var param = healthManage.getQueryCondition(data);
				$.ajax({
					type : "GET",
					url : "/health/page",//TODO
					cache : false, //禁用缓存
					data : param, //传入已封装的参数
					dataType : "json",
	...
	var healthManage = {
		...
		getQueryCondition : function(data) {
			...
			//组装查询参数
			param.fuzzySearch = healthManage.fuzzySearch;
			if (healthManage.fuzzySearch) {//模糊查询
