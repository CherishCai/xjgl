	...
	$(document).ready(function() {
		oTable = $('#otable').DataTable(
			...
			"ajax" : function(data, callback, settings) {
				//封装请求参数
				var param = storeManage.getQueryCondition(data);
				$.ajax({
					type : "GET",
					url : "/store/page",//TODO
					cache : false, //禁用缓存
	...
	var storeManage = {
		...
		getQueryCondition : function(data) {
			...
			//组装查询参数
			param.fuzzySearch = storeManage.fuzzySearch;
			if (storeManage.fuzzySearch) {//模糊查询
